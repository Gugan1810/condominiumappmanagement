...
$conn = new mysqli($servername, $username, $password, $dbname);
 ...
 if($_POST['visitorName']){
     ...
     $stmt = $conn->prepare("SELECT visitorID,visitorName,phoneNumber,checkInDate,checkOutDate,noOfVisitors,vehicleType,plateNumber,licenceNumber FROM visitors WHERE visitorName = ?");
